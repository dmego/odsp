...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager){
        ...
        filterMap.put("myLoginFilter",new MyLoginFilter());
        shiroFilter.setFilters(filterMap);

        //拦截配置
        Map<String,String> filterChainDefinitions = new LinkedHashMap<String,String>();
        filterChainDefinitions.put("/assets/**","anon"); //静态资源
        filterChainDefinitions.put("/module/**","anon"); //
        filterChainDefinitions.put("/api/**","anon"); //API 接口
        filterChainDefinitions.put("/druid/**","anon"); // druid 监控
        filterChainDefinitions.put("/login","anon"); //登录入口
        filterChainDefinitions.put("/logout","logout"); //退出登录
        filterChainDefinitions.put("/**","myLoginFilter,authc"); //其他请求
    ...
    /**
     * Shiro 里实现的 advisor 类,用来拦截注解的方法
     * @return
     */
    @Bean
